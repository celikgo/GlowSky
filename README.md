...
| **Desktop app** *(Phase 1)* | `apps/desktop/` | **Tauri 2 + React + Vite + TS** desktop client themed in the Twitter **Dim** palette. The Design screen drives the agentic loop end-to-end (goal + seed → plan, candidate cards, explanation, trace, notebook/report export) against the FastAPI backend. See `apps/desktop/README.md` |
